...
/** A policy allowed by the API key.
  ...
  *
  * Twilio's permission representation has some quirks. When all sub-permissions (read, write, etc.)
  * are set for a resource like `/twilio/voice/sip.connection-policies`, the API returns a single
  * wildcard permission: `/twilio/voice/sip.connection-policies&#47;*`.
  *
...
object ApiKeyPolicy extends EnumWithTwilioString[ApiKeyPolicy] {
  ...
  case object CallsNotificationsRead extends ApiKeyPolicy("/twilio/voice/calls.notifications/read")
  ...
  /** The Notifications subresource on any given Call. */
  case object CallsNotificationsList extends ApiKeyPolicy("/twilio/voice/calls.notifications/list")
  ...
  /** A Transcript resource represents a voice conversation that has automatically been converted to
    * text through Voice Intelligence.
    */
  ...
  /** Contain the credentials resource entry of the users who are allowed to reach your SIP Domain.
    */
  case object SipCredentialListsCredentialsAll
      extends ApiKeyPolicy("/twilio/voice/sip.credential-lists.credentials/*")

  /** The Conference resource allows you to query and manage the state of conferences on your Twilio
    * account.
    */
  ...
  /** Describes the publicly-routable Static IP addresses that can be used to receive Termination
    ...
    */
  case object SipSourceIpMappingsAll extends ApiKeyPolicy("/twilio/voice/sip.source-ip-mappings/*")
  ...
  case object InsightsCallEventsList extends ApiKeyPolicy("/twilio/voice/insights.call.events/list")
  ...
  case object InsightsSettingsUpdate extends ApiKeyPolicy("/twilio/voice/insights.settings/update")
  ...
  /** Add-on results live as a subresource under the integration point that the Add-on was
    * configured with.
    */
  case object RecordingsAddOnsDelete extends ApiKeyPolicy("/twilio/voice/recordings.add-ons/delete")
  ...
  /** Elastic SIP Trunking enables you to make & receive telephone calls from your IP communications
    * infrastructure.
    */
  ...
  case object IntelligenceServicesAll extends ApiKeyPolicy("/twilio/voice/intelligence.services/*")
  ...
  /** Contain the credentials of the users who are allowed to reach your SIP Domain. */
  case object SipCredentialListsRead extends ApiKeyPolicy("/twilio/voice/sip.credential-lists/read")

  /** Contain the credentials of the users who are allowed to reach your SIP Domain. */
  case object SipCredentialListsList extends ApiKeyPolicy("/twilio/voice/sip.credential-lists/list")
  ...
  /** A general pattern for how one system can be notified of events generated by another system in
    * real-time.
    */
  ...
  /** Lets developers request Verify Push retry sending a push notification for the same Challenge.
    */
  ...
  /** The MessageFeedback subresource represents the reported outcome of tracking the performance of
    * a user action taken by the recipient of the message.
    */
  ...
  /** TaskRouter creates a Reservation subresource whenever a Task is reserved for a Worker.
    * TaskRouter will provide the details of this Reservation Instance subresource in the Assignment
    * Callback HTTP request it makes to your application server.
    */
  ...
  /** Workers represent an entity that is able to perform tasks, such as an agent working in a call
    * center, or a salesperson handling leads.
    */
  ...
  /** Cumulative statistics for your Workers over a certain time period. Cumulative statistics allow
    * you to analyze Worker data from the past 30 days.
    */
  ...
  /** Query information on a phone number so that you can make a trusted interaction with the user.
    */
  ...
  /** Represents Twilio Accounts. When customers first sign up with Twilio, they have just one main
    * account and they can create more accounts and subaccounts for segmenting phone numbers and
    * usage data for their customers and controlling access to data.
    */
  ...
  case object StudioFlowsValidateUpdate extends ApiKeyPolicy("/twilio/studio/flows.validate/update")
  ...
  /** Runtime processing of a Widget, starting when that Widget is entered. Variables get set at the
    * end of a Step.
    */
  case object StudioExecutionsStepsRead extends ApiKeyPolicy("/twilio/studio/executions.steps/read")

  /** Runtime processing of a Widget, starting when that Widget is entered. Variables get set at the
    * end of a Step.
    */
  case object StudioExecutionsStepsList extends ApiKeyPolicy("/twilio/studio/executions.steps/list")
  ...
  /** Bundle is a container that references the required Regulatory Compliance information set forth
    * by the regulating telecom body of the end-user.
    */
  ...
  /** End-User is the entity that answers the phone call or receives the message of a phone number.
    * An entity can be either an individual or a business.
    */
  ...
  /** Replace Items allows you to update compliance info when Regulations change while provisioning
    * new Phone Numbers.
    */
  ...
  /** Bundle Copy allows you to update compliance information when Regulations change while keeping
    * Phone Number provisioning habits.
    */
  ...
  /** Allows you to view and understand Regulations. Regulations are requirements based on End-Users
    * and Supporting Documents set by each country's government.
    */
  ...
  /** Events is a platform feature that provides comprehensive event-logging and change-tracking for
    * Twilio resources. The Events REST resource provides an API to retrieve event-log.
    */
  ...
  /** Generates a self-signed OpenSSL certificate to authenticate calls to Salesforce telephony APIs
    */
  ...
  /** Multi-party communications session where participants share real-time audio and video tracks.
    */
  ...
  /** Media file created as a result of applying a set of media processing operations onto a number
