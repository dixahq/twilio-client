...
final class CompleteConferenceTest extends TwilioClientTest {
  ...
  private val twilioCompleteConferenceResponseJson =
    """{
      ...
      |  "uri": "/2010-04-01/Accouts/ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX/Conferences/TwilioTestConference1Sid.json",
      ...
      |  "subresource_uris": {
      |    "participants": "/2010-04-01/Accounts/ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX/Conferences/TwilioTestConference1Sid/Participants.json",
      |    "recordings": "/2010-04-01/Accounts/ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX/Conferences/TwilioTestConference1Sid/Recordings.json"
      |  }
      |}
      |""".stripMargin
          ...
          WireMock
            .post(
              WireMock.urlPathEqualTo(
                "/2010-04-01/Accounts/ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX/Conferences/TwilioTestConference1Sid.json"
              )
            )
