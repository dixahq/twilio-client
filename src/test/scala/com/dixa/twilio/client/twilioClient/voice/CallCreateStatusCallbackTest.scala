...
final class CallCreateStatusCallbackTest extends TwilioClientTest {

  classOf[TwilioClientVoice].getSimpleName when {
    "is asked to create a call" should {
      "create a call with provided status callback url" in {
        ...
        val expected = Right(
          Call(
            ...
            from = Call.CallerId("+18668675310"),
            fromFormatted = Call.FormattedPhoneNumber("(866) 867-5310"),
            groupSid = None,
            parentCallSid = None,
            phoneNumberSid =
            ...
            to = Call.CallerId("+14155551212"),
            toFormatted = Call.FormattedPhoneNumber("(415) 555-1212"),
            trunkSid = None,
  ...
  final class Fixture {
    ...
    val statusCallbackUrl = CallbackUrl("https://www.myapp.com/events")
    val request =
