...
import com.dixa.twilio.client.voice.{CallRecordingReadRequestExecutor, TwilioClientVoice}
...
final class CallRecordingReadTest extends TwilioClientTest with Matchers {

  classOf[TwilioClientVoice].getSimpleName when {

    "read recordings" should {

      "Support reading all call recording from account" in {
        ...
        val expectedPath =
          s"/2010-04-01/Accounts/${TwilioTestConstants.accountSid}/Calls/$callSid1/Recordings.json?CallSid=${callSid1.twilioString}"
        ...
        val resultFut: Future[
          Seq[Either[CallRecordingReadRequestExecutor.CallRecordingReadException, Recording]]
        ] =
      ...
      "Return a Left if credentials are wrong" in {
        ...
        val expectedPath =
          s"/2010-04-01/Accounts/${TwilioTestConstants.accountSid}/Calls/$callSid1/Recordings.json?CallSid=$callSid1"
        ...
        val expected =
          Left(
            CallRecordingReadRequestExecutor.CallRecordingReadException.Api(
  ...
  final class Fixture {
    ...
    val instance: CallRecordingReadRequestExecutor =
      TwilioClient.defaultImpl().voice.callRecordingRead
  }
}
